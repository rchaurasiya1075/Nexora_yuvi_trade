...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-zclcNQGo.mjs");
...
var manifest = { "25904f70852851d97d8b3575d36e3bd4815c95d22c31dfb69a761e9f97381261": {
	functionName: "fetchLiveQuotes_createServerFn_handler",
	importer: () => import("./quotes-CME-65x1.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-eJAXCzYG.mjs").then((n) => n.t),
